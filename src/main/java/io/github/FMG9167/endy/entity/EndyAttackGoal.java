...
public class EndyAttackGoal extends MeleeAttackGoal {
    private final EndyEntity entity;
    private int attackDelay = 3;
    private int ticksUntilNextAttack = 6;
    private boolean shouldCountTillNextAttack = false;

    public EndyAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((EndyEntity) mob);
    }
